...
4. **Generate message** with a 3-sentence framework adapted to the contact type:
   ...
   - **Sentence 2 (Proof)**: Candidate's biggest quantifiable achievement that shows they have solved similar problems
   ...
   - **Note**: Light tone, not desperate. The goal is to show them you prepared.

5. **Versions**:
   - EN (default)
   - ES (if Spanish company)

6. **Alternative targets** with justification of why they are good second choices
